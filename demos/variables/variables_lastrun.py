...
expName = 'variables'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\matt\\gits\\coding-psychopy-2024\\demos\\variables\\variables_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='',
        font='Arial',
        pos=(-.4, 0), height=0.05, wrapWidth=None, ori=0.0, 
    ...
    for thisTrial in trials:
        ...
        this_cat = cats[i]
        image_3.setImage(this_cat)
        text.setText(this_cat)
        # keep track of which components have finished
        trialComponents = [image_3, text]
