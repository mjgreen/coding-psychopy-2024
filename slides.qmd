...
Faster than frame-rate actions can be done in loops in code components -- components themselves are limited by the frame rate: "do every frame" is the most frequent option.
